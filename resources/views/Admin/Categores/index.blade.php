                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <!-- add_form -->
                                                    <form action="{{ route('categores.update', $category->id) }}"
                                                        method="post">
                                                        @method('patch')
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col">
                                                                <label for="category_name" class="mr-sm-2">اسم القسم
                                                                    :</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="exampleFormControlTextarea1">تفاصيل القسم
                                                                :</label>
                                    ...
                                    <div class="modal fade" id="delete{{ $category->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('categores.destroy', $category->id) }}"
                                                        method="post">
                                                        @method('Delete')
                                                        @csrf
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- add_form -->
                        <form action="{{ route('categores.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col">
                                    <label for="Name" class="mr-sm-2">اسم القسم
                                        :</label>
                                    <input id="Name" type="text" name="category_name" class="form-control"
                                        value="">
                                </div>
