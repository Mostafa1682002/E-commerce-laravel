                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                    ...
                                    <div class="card-body">
                                        <div class="billing-address-form">
                                            <form action="{{ route('checkout_store') }}" class="form" method="POST">
                                                @csrf
                                                ...
                                                @enderror
                                                <p><input type="tel" placeholder="Phone" name="phone"
                                                        value="{{ old('phone') }}"></p>
                                                @error('phone')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                                <p>
                                                    <textarea name="notes" id="bill" cols="30" rows="10" placeholder="Say Something">{{ old('notes') }}</textarea>
                                                </p>
                                        </div>
                                    </div>
                                </div>
