                    ...
                    <div class="testimonial-sliders">
                        <div class="single-testimonial-slider">
                            <div class="client-avater">
                                <img src="{{ asset('user/img/avaters/avatar1.png') }}" alt="" />
                            </div>
                        ...
                        <div class="single-testimonial-slider">
                            <div class="client-avater">
                                <img src="{{ asset('user/img/avaters/avatar2.png') }}" alt="" />
                            </div>
                            <div class="client-meta">
                                <h3>
                        ...
                        <div class="single-testimonial-slider">
                            <div class="client-avater">
                                <img src="{{ asset('user/img/avaters/avatar3.png') }}" alt="" />
                            </div>
                            <div class="client-meta">
                                <h3>
                                    Jacob Sikim
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <p>
                        ...
                        <a href="https://imransdesign.com/">Imran Hossain</a>, All Rights Reserved.<br />
                        Distributed By -
